  ...
  return (
    <div className="sticky top-24">
      ...
      >
        ...
        <Link
          href="/workspace"
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-violet-500 to-blue-500 py-2.5 text-xs font-medium text-white transition-opacity hover:opacity-90"
        >
